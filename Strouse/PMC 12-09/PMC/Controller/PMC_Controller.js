...
let lotBinData = {};
let woIssueData = {}
let troubleshootingGuideLink = `https://4344933-sb1.app.netsuite.com/app/common/custom/custrecordentrylist.nl?rectype=1561`
    ...
    openWorkOrderDataTable.off('select').on('select', async () => {
        ...
        let informationObj = {
            ...
            'runRateUnitsPerMinutes': {
                'fieldName': 'Run Rate Units Per Minutes',
