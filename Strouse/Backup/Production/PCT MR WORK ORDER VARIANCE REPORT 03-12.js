    ...
    function (record, log, search, runtime, file, formati) {
        ...
        function reduce(context) {
            ...
            try {
                ...
                let sceResponse = getLatestSceId(getAssembly(workOrderId))
                let sceId = sceResponse.sceId
                let sceDocumentNumber = sceResponse.sceNumber;
                let sceQty = sceResponse.sceQty;
                // log.debug("PCT-sceDocumentNumber", sceDocumentNumber)
        ...
        const getEstimateDataFromMFGOperationTask = (workOrderArray, costCategoryObj, sceId, sceDocumentNumber) => {
            ...
            manufacturingoperationtaskSearchObj.run().each(function (result) {
                ...
                // log.debug("PCT", "Sandipan - estRunTime" + operationObj.estRunTime);
