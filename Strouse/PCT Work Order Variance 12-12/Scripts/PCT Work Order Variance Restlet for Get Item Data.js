        ...
        do {
            ...
            for (let woIndex = 0; woIndex < result.length; woIndex++) {
                ...
                if (costingMethod == 'AVG') {
                    estimatedItemRate = itemEstimatedQuantity * parseFloat(result[woIndex].getValue({
                        name: "locationaveragecost",
                        join: "item",
                        summary: "MAX",
                        label: "Location Average Cost"
                ...
                log.debug("PCT", "Item Cost : " + estimatedItemRate + " type of : " + typeof estimatedItemRate)

                if (estimatedItemRate == null || estimatedItemRate == "" || estimatedItemRate == 'NaN' || estimatedItemRate == NaN || estimatedItemRate == 'undefined' || estimatedItemRate == undefined || isNaN(estimatedItemRate)) {
                    itemObj.estimatedItemRate = 0;
                }
                else {
                    itemObj.estimatedItemRate = estimatedItemRate;
                }
    ...
    const getActualItemDetails = (workOrderEstimatedItemDataObj, workOrderArray) => {
        ...
        do {
            ...
            for (let issueIndex = 0; issueIndex < result.length; issueIndex++) {
                ...
                if (itemObj.actualItemRate == null || itemObj.actualItemRate == "" || itemObj.actualItemRate == 'NaN' || itemObj.actualItemRate == NaN || itemObj.actualItemRate == 'undefined' || itemObj.actualItemRate == undefined) {
