...
$(document).ready(async () => {
    ...
    $("#workOrderIssue").click(async () => {
        ...
        // workOderIssueTableData.columnsArr.push({ 'title': 'Qty Used', 'defaultContent': `<input type="number" class="form-control issueQuantity" value="${workOderIssueTableData.data.commited}">` });
...
const stopTimerClock = async () => {
    ...
    if (selectedRowData.pmcTransactionName.toLowerCase() === 'production') {
        ...
        Swal.fire({
            ...
            html: `<div><input type="number" value="" class="swal2-input" id="productionQuantity" placeholder="Production Qty" min='0' step='0.01'><span id="swal_uom" style="font-size:40px;font-weight: bold;">${selectedRowData.workOrderUnit}</span></div><div>`,
