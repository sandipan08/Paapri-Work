                        ...
                        if (count_chk != 0)
                        {
                            for (var lot_label = 0; lot_label < quantity_length; lot_label++)
                            {
                                for (var lot_label1 = 0; lot_label1 < lot_quantity[lot_label]; lot_label1++)
                                {
                                    ...
                                    {
                                        // myvar += '<td width="100%">' +
                                        //     '<barcode align="center"  width="175" height="17" codetype="code128" showtext="false" value="' + trimmedName + '"/>' +
                                        //     '</td>' +
                                        myvar += '<td width="100%">' +
                                            '<barcode align="center" margin-left="-9px" width="140" height="20" codetype="code128" showtext="false" value="' + lot[lot_label] + '"/>' +
                                            '</td>' +
                                            '</tr>';
                                        myvar += '<tr>' +
