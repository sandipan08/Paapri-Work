...
define(['N/record', 'N/format', 'N/search', 'N/runtime'], function (record, format, search, runtime) {
    ...
    const createPMCTransaction = (setupDataObj) => {
        try {
            ...
            let pmcTransactionRecordId = record.create({
                ...
                text: dateFormatterWithOutSec(setupDataObj.startDate),
                ignoreFieldChange: false
            }).save();
    ...
    const getDowntimeRecordId = (setupDataObj) => {
        ...
        var downTimeIdCount = customrecord_pct_pmc_tranSearchObj.runPaged().count;
    ...
    const dateFormatterWithOutSec = (date) => {
       ...
       // let dateTimeWithSec = date //5/22/2024 4:51:08 pm
