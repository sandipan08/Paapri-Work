...
define(['N/record', 'N/format', 'N/search', 'N/runtime'], function (record, format, search, runtime) {
        ...
        try {
            ...
            if (setupDataObj.pmcTransactionEndTime) {
                pmcTransactionRecordLoad.setText({
                    ...
                    fieldId: 'custrecord_pct_sc_production_shift',
                    value: setupDataObj.productionShift,
                    ignoreFieldChange: false
                }).save();
            }
            // ----------------- For Downtime Start --------------
            ...
            // ----------------- For Downtime End --------------
                ...
                log.debug('downTimeId', downTimeId)
                record.submitFields({
                    type: 'customrecord_pct_pmc_downtime',
                    id: downTimeId,
                    values: {
    ...
    const getDowntimeRecordId = (setupDataObj) => {
        log.debug("PCT", "SetUp Obj : "+ JSON.stringify(setupDataObj))
