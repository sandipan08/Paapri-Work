...
define(['N/file', 'N/record', 'N/search', 'N/https', 'N/log'],
  function (file, record, search, https, log) {
    ...
    function onRequest(context) {
      ...
      var parentFolder, viewFolder, imageFolder, controllerFolder, parentFolderv2;
      ...
      if (context.request.method === 'GET') {
        ...
        const parentFolderResultv2 = findParentFolderv2();
        const parentFolderSearchResult = parentFolderResult[0];
        const parentFolderSearchResultv2 = parentFolderResultv2[0];
        const parentFolderSearchResultCount = parentFolderResult[1];
        const parentFolderSearchResultCountv2 = parentFolderResultv2[1];
        ...
        if (parentFolderSearchResultCountv2 != 0) {
          parentFolderv2 = parentFolderSearchResultv2[0].getValue("internalid");
        }
        else {
          log.audit({
            title: 'Parent Folder v2',
            details: 'Parent Folder [PCT MOTT Timesheet PMC] Not Found'
          });
        }
        ...
        const viewFolderResult = findSubFolder(parentFolderv2, "View");
        ...
        const controllerFolderResult = findSubFolder(parentFolderv2, "Controller");
        ...
        const htmlFileResult = findFile(viewFolder, "PCT_MOTT_TIMESHEET_Index v2.html");
        ...
        const controllerFileResult = findFile(controllerFolder, "PCT_MOTT_TIMESHEET_Controller v2.js");
    ...
    function findParentFolderv2() {
      ...
      var folderSearchObj = search.create({
        ...
        filters:
          [
            //["name","is","PCT MOTT Timesheet PMC"]
            ["name", "is", "PCT MOTT Timesheet PMC Duplicate"]
          ],
        columns:
          [
            search.createColumn({ name: "internalid", label: "Internal ID" })
