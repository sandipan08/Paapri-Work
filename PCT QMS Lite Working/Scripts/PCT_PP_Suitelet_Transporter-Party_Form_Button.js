    ...
    function (serverWidget, xml, log, render, record)
    {
        function onRequest(context)
        {
            ...
            if (context.request.method === 'GET')
            {
                ...
                var invoiceNo = transporterPartyReceiptLoad.getText({ fieldId: 'custrecord_pct_pp_tr_inv_no' });
                ...
                var myvar = '<?xml version="1.0"?><!DOCTYPE pdf PUBLIC "-//big.faceless.org//report" "report-1.1.dtd">' +
                    ...
                    '    <h2 style="font-size: 10pt; margin: 5px 7px;">Packaging Details</h2>' +
                ...
                myvar += '</table>';
                myvar += '          <table style="width: 100%; white-space: nowrap; margin-left: 0px; margin-right: 234px; font-size: 8pt; border: 1px solid #dddddd;">' +
                    '                    <tr>' +
                    '                        <th style="white-space: nowrap; padding: 3px 6px;">Total</th>' +
                    '                        <td style="white-space: nowrap; padding: 3px 6px; margin-left: 5px;"><b>' + totalPackaging + '</b></td>' +
                    '                    </tr>' +
                    '               </table>' +
                    '</body>' +
                    '</pdf>';
