        ...
        function _get(context) {
            ...
            for (var index = 0; index < noOfLabel; index++) {
                if (labelType == 1) {//small
                    myvar += "<body width='2.8cm' height='1.5cm' style='text-align:left; padding-top:2.85px;'>";
                    myvar += '<table style="font-size:5.25;text-align:left; padding-left:-38px; padding-top:-5px; font-weight:bold;" >' +
                        '  <tr>' +
                        '    <td colspan="3" style="padding-left:-1px; white-space: pre;">' + barcodeObj['custitem_pct_pp_med_small_label'] + '</td>' +
                        '    ' +
                        '  </tr>' +
                        '  <tr style="padding-top:-4px;">' +
                        '    <td  style="padding-left:0px; white-space: nowrap;">Packing: <br/> M.R.P: <br/> Mfg .: <br/> Batch: <br/> </td>' +
                        '    <td  style="padding-left:2px;white-space: nowrap;">'
                        ...
                        '<td align="right" style="padding-right: -47px; padding-top:-2px;"> <barcode codetype="qrcode" showtext="true" width="1.1cm" height="1cm" value="' + barcodeObj['displayname'] + '"/> </td>' +
                        '  </tr>' +
                        '</table>';
                    ...
                    myvar += "<body width='3.8cm' height='4cm' style='text-align:left; padding-top:18.5px;'>";
                    myvar += '<table style="font-size:7.5;text-align:left; padding-left:-38px; font-weight:bold;" >' +
                        '  <tr>' +
                        ...
                        '    <td  style="padding-left:-1px; white-space: nowrap;">Packing: <br/> M. R. P: <br/> M f g   .  : <br/> Batch . : <br/> </td>' +
                        '    <td  style="padding-left:-5px;white-space: nowrap;">'
                        + barcodeObj['custitem_pct_pp_item_size'][0].text + '<br/>' +
                        ' Rs. ' + parseFloat(barcodeObj['custitem_pct_pp_mrp']).toFixed(2) + '<br/>'
                        + date + ' <br/>' + assNameObj['custbody_pct_pp_batch_number'] + '</td>' +
                        '<td align="right" style="padding-right: -47px;"> <barcode codetype="qrcode" showtext="true" width="1.4cm" height="1.5cm" value="' + barcodeObj['displayname'] + '"/> </td>' +
                        '  </tr>' +
                    ...
                    myvar += "<body width='7.5cm' height='5cm' style='text-align:left; padding-top:15px;'>";
                    myvar += '<table style="font-size:12;text-align:left; padding-left:-30px; font-weight:bold;" >' +
                        '  <tr>' +
                        '    <td colspan="2" style="padding-left:1px; white-space: pre;">' + barcodeObj['custitem_pct_pp_med_small_label'] + '</td>' +
                        '  </tr>' +
                        ...
                        ' Rs. ' + parseFloat(barcodeObj['custitem_pct_pp_mrp']).toFixed(2) + '<br/>'
                        + date + ' <br/>' + assNameObj['custbody_pct_pp_batch_number'] + '</td>' +
                        '<td align="right" style="padding-right: -25px;padding-top:-7px;"> <barcode codetype="qrcode" showtext="true" width="2.6cm" height="2.6cm" value="' + barcodeObj['displayname'] + '"/> </td>' +
                        '  </tr>' +
