    ...
    function(dialog, serverWidget, search, redirect, record, url, http, https, message, format, render, file, log, encode) {
        ...
        function main_function(context, transPrintid, record_type) {
            try {
                ...
                var custbody_reason_for_extend_validity = invoice_obj.getText('custbody_reason_for_extend_validity');
                ...
                var custbody_eway_bill_response = invoice_obj.getValue('custbody_eway_bill_response');
                    ...
                    var request_data = {
                        ...
                        "remaining_distance": parseInt(custbody_remaining_distance), //need to open
                        ...
                        "extend_validity_reason": custbody_reason_for_extend_validity, //need to open  
                        "extend_remarks": "Flood",
                        "from_pincode": parseInt(zip),
                    ...
                    var postRequest = https.post({
                        url: 'https://pro.mastersindia.co/ewayBillValidityExtend',
                        headers: headers,
                    ...
                    if (status == '200') {
                        record.submitFields({
                            ...
                            "id": transPrintid,
                            "values": {
                                "custbody_extend_ewayresponse": "1",
                            }
                        });
                    } else if (status == '204') {
                        ...
                        record.submitFields({
                            ...
                            "id": transPrintid,
                            "values": {
                                "custbody_extend_ewayresponse": stXMLRequest.results.message
                            }
                        });
                    }
