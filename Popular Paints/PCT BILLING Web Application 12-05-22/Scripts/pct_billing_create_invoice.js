/**
 *              //////////     PCT BILLING | INVOICE GENERATION SUITELET     //////////
 *
...
define(['N/search', 'N/record', 'N/log', 'N/url', 'N/redirect'], function (search, record, log, url, redirect)
{
    function onRequest(context)
    {
        ...
        for (var itemIndex = 0; itemIndex < itemLineCount; itemIndex++)
        {
            ...
            var qty = parseFloat(data[itemId])
            log.debug({
                title: 'Qty',
                details: qty
            });
        ...
        objRecord.setText({ fieldId: 'custbody_pct_pp_so_created_by', text: custparam_userName });
        ...
        content +=
            ...
            `             <button type="button" class="btn btn-info back">Go Back</button>` +
