/**
 *              //////////     PCT BILLING | LOGIN EMAIL PAGE SUITELET     //////////
 *
    ...
    function (file, render, search, log, redirect, record, format, email) {
        ...
        function onRequest(context) {
            ...
            if (request.method == 'GET') {
                ...
                var templateFile = file.load({ id: 'SuiteScripts/PCT BILLING Web Application/HTML Files/pct_billing_login_email_page.html' });
                ...
                log.debug({
                    title: "PCT_PP",
                    details: "User : "+isUserExisit.isSuccess
                })
                ...
                if (isUserExisit.isSuccess) {
                    ...
                    redirect.toSuitelet({
                        scriptId: 'customscript_pct_billing_login',
                        deploymentId: 'customdeploy_pct_billing_login',
                        isExternal: true,
                        parameters: {
        ...
        //         filters:
        //             [
        //                 ["custrecord_pct_billing_otp_email", "is", email_id]
        //             ],
        //         columns:
        //             [
        ...
        //             ]
        //     });
        //     if (customrecord_pct_billing_otpSearchObj != null) {
        ...
        //     Record.setText({
        //         fieldId: 'custrecord_pct_billing_otp_email',
        //         text: email_id
        //     });

        //     Record.setText({
        //         fieldId: 'custrecord_pct_billing_otp_pin',
        //         text: random
        //     });

        //     Record.setText({
        //         fieldId: 'custrecord_pct_billing_otp_ip',
        //         text: ip
        //     });

        //     Record.setText({
        //         fieldId: 'custrecord_pct_billing_otp_device',
        //         text: user_agent
        //     });
        //     Record.setText({
        //         fieldId: 'custrecord_pct_billing_otp_cookie',
        //         text: cookie
        //     });


        //     Record.setValue({
        //         fieldId: 'custrecord_pct_billing_otp_employee',
        //         value: userId
        //     });
        ...
        function IsUserExist(userEmail) {
            ...
            var employeeSearchObj = search.create({
                ...
                filters:
                    [
                        ...
                        "AND",
                        ["custentity_pct_pp_billing_password", "isnotempty", ""]
                    ],
                columns:
                    [
                        search.createColumn({ name: "internalid", label: "Internal ID" }),
            ...
            if (searchResultCount > 0) {
                employeeSearchObj.run().each(function (result) {
                    ...
                    user.userEmail = result.getValue({ name: 'email' });
