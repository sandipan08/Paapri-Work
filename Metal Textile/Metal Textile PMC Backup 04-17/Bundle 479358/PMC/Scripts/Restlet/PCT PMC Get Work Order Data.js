...
define(['N/record', 'N/search'], function (record, search) {
        ...
        try {
            var customrecord_pct_pmc_tran_k_fabSearchObj = search.create({
                ...
                columns:
                    [
                        ...
                        search.createColumn({ name: "custrecord_pct_pmc_total_time", label: "DURATION" }),
                        search.createColumn({
            ...
            if (searchResultCount > 0) {
                customrecord_pct_pmc_tran_k_fabSearchObj.run().each(function (result) {
                    ...
                    res.duration = result.getValue({ name: "custrecord_pct_pmc_total_time" })
    ...
    const getTableHeaders = () => {
        return {
            ...
            'workInstructionTitleArr': ['OPERATION SEQUENCE','WORK CENTER', 'WORK INSTRUCTION','URL'],//, 'OPERATION NAME', 'WORK CENTER',
