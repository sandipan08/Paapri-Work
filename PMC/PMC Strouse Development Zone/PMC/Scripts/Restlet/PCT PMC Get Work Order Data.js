...
define(['N/record', 'N/search'], function (record, search) {
    ...
    function _get(context) {
        try {
            ...
            // let toolFamilyTaskDetails = getToolRouting(workOrderId, operationSequence);
        ...
        try {
            ...
            if (searchResultCount > 0) {
                customrecord_pct_pmc_work_instructionSearchObj.run().each(function (result) {
                    ...
                    res.folder = result.getValue({ name: "custrecord_pct_pmc_work_ins_folder" })
    ...
    const getTableHeaders = () => {
        return {
            'itemsTableTitleArr': ['Item', 'ItemId', 'Quantity', 'Used In Build', 'Commited', 'Back Ordered', 'Component Yield', 'Bom Quantity', 'Units', 'Line No'],
            ...
            'toolFamilyTableTitleArr': ['Internal Id', 'Document Number', 'Routing Name', 'Tool Item #', 'Used In Step Number', 'Available', 'Quantity', 'Serialized Tool'],
            ...
            'serializedToolTitleArr': ['Tool Item #', 'Serialized Internal Id', 'Serialized Tool', 'Tool Life'],
