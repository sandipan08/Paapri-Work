    ...
    function (file, render, url, record, format) {
        ...
        function onRequest(context) {
            ...
            if (request.method == 'GET') {
                ...
                var templateFile = file.load({ id: './PMC Lite Web Application/PMC Lite 2.1 Templates/pct_pmclite_logout_page.html' });
        ...
        /**
         * This method is used to update PMC Transaction Table.
         * 
         * @param {string} actionType 
         * @param {string} recordId 
         */
        function UpdateTransactionRecord(actionType, recordId) {
            var now = new Date();
            ...
            var customRecord = record.load({
                ...
                fieldId: 'custrecord_pct_pmclite_trans_action_type',
                text: actionType,
