    ...
    function (file, render, url, record, format, redirect, search) {
        ...
        function onRequest(context) {
            ...
            if (request.method == 'GET') {
                ...
                var breakHour = request.parameters.custparam_breakHour;
                var breakMin = request.parameters.custparam_breakMin;
                var breakSec = request.parameters.custparam_breakSec;
                ...
                redirect.toSuitelet({
                    ...
                    parameters: {
                        ...
                        'custparam_mode': 'BACK_FROM_BREAK_MODE',
                        'custparam_startRecordId': startRecordId,
                        'custparam_ticketNumber': ticketNumber,
                        'custparam_backFromBreak': backFromBreak,
                        'custparam_breakHour': breakHour,
                        'custparam_breakMin': breakMin,
                        'custparam_breakSec': breakSec
                    }
                });
