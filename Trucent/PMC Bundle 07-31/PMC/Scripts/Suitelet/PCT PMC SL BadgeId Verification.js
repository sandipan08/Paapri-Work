 ...
 * 2.00        28 June 2022          Rajesh Nandi
 *
 *
 *@NApiVersion 2.1
...
define(['N/search', 'N/record', 'N/runtime'], function (search, record, runtime) {
    ...
    const onRequest = (context) => {
        const request = context.request.parameters;
    ...
    function _get(request, response) {
        let employeeDetailsObj = verifyEmployeeWithBadgeId(request.badgeId);
        ...
        response.write(JSON.stringify(employeeDetailsObj))
    }
