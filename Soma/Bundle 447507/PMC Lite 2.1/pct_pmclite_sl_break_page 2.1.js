    ...
    function (file, render, url, record, format, redirect, search) {
        ...
        function onRequest(context) {
            ...
            if (request.method == 'GET') {
                ...
                log.debug("PCT-Get", "Parameters : " + JSON.stringify(request.parameters))
                ...
                var operationId = request.parameters.custparam_opInternalId;
                var workCenter = request.parameters.custparam_workCenter;
                var workCenterName = request.parameters.custparam_workCenterName;
                ...
                if (responseData.isSuccess) {
                    ...
                    UpdateTransactionRecord(recordId, userId, selectedBreakOption, breakCategory, operationId, ticketNumber);
                ...
                log.debug("PCT-Post", "Parameters : " + JSON.stringify(request.parameters))
                var userName = request.parameters.custparam_userName;
                var userId = request.parameters.custparam_userId;
                var loginRecordId = request.parameters.custparam_loginRecordId;
                ...
                log.debug({
                    title: "PCT-post",
                    details: "Ticket Number : " + ticketNumber + ", work center name : " + workCenterName
                })
        ...
        function UpdateTransactionRecord(recordId, userId, selectedBreakOption, breakCategory, operationId, ticketNumber) {
            var now = new Date();
      ...
      */
        ...
        function CreateTransactionRecord(userId, actionType, notes, operationId) {
            ...
            var recordId = record.create({
                ...
                fieldId: "custrecord_pct_kfab_ref",
                value: notes,
                ignoreFieldChange: true
            }).setText({
                fieldId: "custrecord_pct_kfab_p_seq",
