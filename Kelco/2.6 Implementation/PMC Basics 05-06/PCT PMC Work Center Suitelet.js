 ...
 *@since        2022-07-27 yyyy-MM-dd
 *@copyright    Paapri Business Technologies (India) Pvt Ltd.
 *@license      The SuiteScript 2.1 code in this page is for PMC 2.1 ( Work Center View ), you can redistribute
                it and/or modify it under the terms of PCT General Public License (PCT GPL) as
                published by the Paapri's TEAM INNOVATION.

 *@description  This Suitelet is for PMC 2.1( Work Center View )
 */
        ...
        if (request.method === 'GET') {
            try {
                let htmlContent = file.load({
                    id: `./PCT PMC Work Center Console.html`
                }).getContents();
                let pathObj = [
                    {
                        'fileType': 'stylesheet',
                        'localPath': './PMC_WorkCenterView_StyleSheet.css'
                    },
                    {
                        'fileType': 'controller',
                        'localPath': './PMC_Controller_WorkCenterView.js'
                    },
                    // {
                    //     'fileType': 'logo',
                ...
                htmlContent = htmlContent.replaceAll('#FETCH-PAAPRI-LOGO#', utilityUrlObj.companyLogo);
                ...
                log.debug("PCT-PMC", "Scrip Id  : " + scriptIdFetchRestletObj.data.scriptInternalId)
