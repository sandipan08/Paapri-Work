...
define(['N/record', 'N/search'], function (record, search) {
    ...
    function _get(context) {
        try {
            ...
            log.debug({
                title: 'PCT-PMC',
                details: `Data =  Routing :  ${JSON.stringify(workOrderOperationTaskDetails)} , `
            })
            ...
            return { 'isSuccess': true, 'workOrderItemDetails': workOrderItemDetails, 'workOrderOperationTaskDetails': workOrderOperationTaskDetails, 'pmcTransactionDetails': pmcTransactionDetails }
    ...
    const getManufacturingOperationTaskData = (workOrderId) => {
        ...
        try {
            ...
            if (searchResultCount > 0) {
                ...
                log.debug("PCT_SC", manufacturingOperationTaskDataArr)
    ...
    const getTableHeaders = () => {
        return {
            'itemsTableTitleArr': ['Item', 'ItemId', 'Quantity', 'Used In Build', 'Committed', 'Back Ordered', 'Component Yield', 'BoM Quantity', 'Units'],
