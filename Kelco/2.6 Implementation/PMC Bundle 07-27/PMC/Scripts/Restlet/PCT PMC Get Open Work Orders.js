...
define(['N/search'], function (search) {
    ...
    const getOpenWorkOrders = (dataObj) => {
        ...
        try {
            ...
            log.debug("PCT-Kelco", filterArray)
            ...
            //     //     "AND",
            //     //     ["workorder.class", "anyof", dataObj.class],
            //     //     "AND",
            //     //     [[["custrecord_pct_kfab_man_op_task.internalid", "anyof", "@NONE@"]], "OR", [["custrecord_pct_kfab_man_op_task.custrecord_pct_kfab_op_status", "noneof", "3"], "AND", ["custrecord_pct_kfab_man_op_task.internalid", "noneof", "@NONE@"]]]
            //     // ]
            // }
            // else {
            //     filterArray.push(["status", "anyof", "PROGRESS", "NOTSTART"])
            ...
            //     // filterArray = [
            //     //     [["custrecord_pct_kfab_man_op_task.name", "is", "Setup"], "OR", ["custrecord_pct_kfab_man_op_task.name", "is", "Production"]],
            //     //     "AND",
            //     //     ["status", "anyof", "PROGRESS", "NOTSTART"],
            //     //     "AND",
            //     //     ["workorder.status", "anyof", "WorkOrd:B", "WorkOrd:D"],
            ...
            //     //     ["workorder.class", "anyof", dataObj.class],
            //     //     "AND",
            //     //     [["custrecord_pct_kfab_man_op_task.internalid", "noneof", "@NONE@"], "AND", ["custrecord_pct_kfab_man_op_task.custrecord_pct_kfab_op_status", "anyof", "3"]]
            ...
            let dataArr = [];
            log.debug("PCT", searchResult)
            log.debug("PCT", searchResult.length)
            ...
            if (searchResult.length) {
                for (let searchIndex = 0; searchIndex < searchResult.length; searchIndex++) {
                    ...
                    resData.units = searchResult[searchIndex].getText({
                        name: "unit",
                        join: "workOrder",
                        summary: "GROUP",
                        label: "Units"
    ...
    const getOpenWorkOrderSearchCount = (dataObj) => {
        ...
        log.debug("PCT-Kelco", searchFilterArray)
