...
$(document).ready(async () => {
    ...
    if (loggedInUserDetails) {
        ...
        let basicDetailsHtml = `<span>Location: ${loggedInUserDetails.locationName}</span><span id='userWorkCenter'> Work Center: ${loggedInUserDetails.pmcWorkCenterName}</span><span id='userClass'> Product Family: ${loggedInUserDetails.className}</span><span id='status'> Status: ${status}</span>`
