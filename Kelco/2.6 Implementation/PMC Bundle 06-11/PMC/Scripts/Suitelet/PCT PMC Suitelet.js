    ...
    function onRequest(context) {
        ...
        if (request.method === 'GET') {
            ...
            let pathObj = [
                ...
                {
                    'fileType': 'companyNameLogo',
                    'localPath': '../../Assets/PCT logo with name.png'
                },
                {
                    'fileType': 'kelcoLogo',
                    'localPath': '../../Assets/KELCO_Logo.png'
                },
            ];
            ...
            htmlContent = htmlContent.replace('#FETCH-PAAPRINAME-LOGO#', utilityUrlObj.companyNameLogo);
            htmlContent = htmlContent.replaceAll('#FETCH-KELCO-LOGO#', utilityUrlObj.kelcoLogo);
