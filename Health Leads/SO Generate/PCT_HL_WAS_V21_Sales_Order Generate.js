    ...
    function (currentRecord, record, runtime, search, email, runtime)
    {
            ...
            else
            {
                ...
                if (customer_count > 0)
                {
                    ...
                    for (customer_index = 0; customer_index < customer_count; customer_index++)
                    {
                        ...
                        addressSubrecord.setText({ fieldId: 'country', text: "United Kingdom" });
                        addressSubrecord.setValue({ fieldId: 'addr1', value: "Country : " + HL_shipping_country });
        ...
        function onAction(scriptContext)
        {
            ...
            function getTaxPercent(MEGLIO_item_taxPer, countryCode)
            {
                ...
                if (searchResultCount == 0 || countryCode != 'GB')
                {
                    taxDetailObj.id = 10;
