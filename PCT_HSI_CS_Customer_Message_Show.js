...
define(["N/record", "N/search", "N/format", "N/error", 'N/runtime',], function (record, search, format, error, runtime)
{
    ...
    function _get(context)
    {
        ...
        var projectManagerName = employeeLookUp.firstname;
        var projectManager = employeeLookUp.isjobmanager;
        log.debug({ title: "PCT-MOTT", details: 'Look Up field Object  : ' + JSON.stringify(employeeLookUp) + ", Project Manager : " + projectManager + ", Project Manager Name : " + projectManagerName });
        ...
        return [projectManagerArray, userObj.id, projectManagerName];
