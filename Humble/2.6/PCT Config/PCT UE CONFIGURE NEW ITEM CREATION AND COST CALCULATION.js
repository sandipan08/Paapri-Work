...
define(['N/search', 'N/record'], function (search, record) {
    ...
    const calculateCost = (recordType, recordId) => {
        ...
        for (let itemLine = 0; itemLine < itemLineCount; itemLine++) {
            ...
            let unitPrice = chcekNull(configRecordObj.getCurrentSublistValue({
                sublistId: 'recmachcustrecord_pct_cpq_link_to_pct_config',
        ...
        log.debug({
            title: 'totalItemPrice',
            details: totalItemPrice
        })
        ...
        perUnitCost = parseFloat(processCost) + parseFloat(totalItemPrice)
        // perUnitCost = parseFloat(materialCost)

        configRecordObj.setValue({
            fieldId: 'custrecord_pct_cpq_item_unit_cost',
            value: parseFloat(materialCost)+ parseFloat(processCost)//perUnitCost
        })
        ...
        configRecordObj.setValue({
            ...
            value: perUnitCost + parseFloat(markupCost)
        })
