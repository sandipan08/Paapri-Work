...
define(['N/record'], function (record) {
    ...
    const getPmcTransactionData = (context) => {
        ...
        try {
            ...
            pmcTransactionRecordObj['workOrderId'] = pmcTransactionRecordLoad.getValue({ fieldId: 'custrecord_pct_pmc_wo' });
            pmcTransactionRecordObj['operationSequence'] = pmcTransactionRecordLoad.getValue({ fieldId: 'custrecord_pct_pmc_p_seq' });
            pmcTransactionRecordObj['operationName'] = pmcTransactionRecordLoad.getValue({ fieldId: 'custrecord_pct_pmc_op_name' });
            pmcTransactionRecordObj['workCenterId'] = pmcTransactionRecordLoad.getValue({ fieldId: 'custrecord_pct_pmc_wo_center' });
            pmcTransactionRecordObj['employeeId'] = pmcTransactionRecordLoad.getValue({ fieldId: 'custrecord_pct_pmc_emp' });
            pmcTransactionRecordObj['operationTaskId'] = pmcTransactionRecordLoad.getValue({ fieldId: 'custrecord_pct_pmc_op_task_id' });
            pmcTransactionRecordObj['operationStatus'] = pmcTransactionRecordLoad.getValue({ fieldId: 'custrecord_pct_pmc_op_status' });
            pmcTransactionRecordObj['manufacturingTask'] = pmcTransactionRecordLoad.getValue({ fieldId: 'custrecord_pct_pmc_man_op_task' });
            pmcTransactionRecordObj['reference'] = pmcTransactionRecordLoad.getValue({ fieldId: 'custrecord_pct_pmc_ref' });
            pmcTransactionRecordObj['resultStartDateTime'] = pmcTransactionRecordLoad.getValue({ fieldId: 'custrecord_pct_pmc_res_start_date' });
            pmcTransactionRecordObj['resultEndDateTime'] = pmcTransactionRecordLoad.getValue({ fieldId: 'custrecord_pct_pmc_res_end_date' });
            pmcTransactionRecordObj['productionQuantity'] = pmcTransactionRecordLoad.getValue({ fieldId: 'custrecord_pct_pmc_prod_qty' });
            ...
            pmcTransactionRecordObj['resultStartDateTimeSecond'] = pmcTransactionRecordLoad.getValue({ fieldId: 'custrecord_pct_pmc_res_start_date_sec' });
